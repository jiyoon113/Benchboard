        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-5 shadow-md">
          ...
          <div className="space-y-3">
            {activeAxes.map((axis) => {
              ...
              return (
                <article key={axis.id} className="rounded-lg border border-neutral-200 bg-neutral-50 p-4">
