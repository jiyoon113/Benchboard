...
const ABILITY: Ruleset = {
  ...
  keyword: [
    ...
    [/mmmu|docvqa|chartqa|ai2d|mathvista|charxiv|vqa|video|vibe-?eval|erqa|zerobench|omnidoc|vista|mmbench|seedbench|realworldqa|blink|muirbench/, ["multimodal", "semantic-comprehension"]],
